...
<body>
    ...
    <div class="pai-login">
        ...
        <div class="direita-login">
            ...
            <div class="">
                <form class="formulario-login" action="inserir-cabeleireiro.php" method="POST">                    
                    <?php
                    ...
                    <div class="col-5  mx-auto mb-2">
                        ...
                        <input type="password" class="form-control input-login" id="confsenha" name="confsenha" required maxlength="150" aria-describedby="confsenha confsenhaFeedback" onblur="verifica_senhas();">
